...
/// Start the clip-mash server
///
/// This function initializes the server with logging, sentry, and all necessary dependencies.
/// It's designed to be called from within a Tauri application or as a standalone server.
