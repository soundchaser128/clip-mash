...
export type ListAlexandriaVideosParams = {
  query?: string | null
  page?: number | null
  size?: number | null
  sort?: string | null
...
export interface AlexandriaVideoPage {
  content: AlexandriaVideo[]
  empty: boolean
  first: boolean
  last: boolean
  number: number
...
export const listAlexandriaVideos = (params?: ListAlexandriaVideosParams) => {
  return customInstance<AlexandriaVideoPage>({
    url: `/api/library/video/alexandria`,
    method: "GET",
    params,
  })
}
...
>
export type ListAlexandriaVideosResult = NonNullable<
  Awaited<ReturnType<typeof listAlexandriaVideos>>
>
